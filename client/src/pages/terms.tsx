    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 border-b bg-card/80 backdrop-blur-sm">
        <div className="max-w-2xl mx-auto flex items-center gap-3 p-4">
          ...
          <h1 className="font-display font-bold text-lg" data-testid="text-terms-title">Terms of Service</h1>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-6 py-8">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-foreground/90">
          <section id="welcome">
            <h2 className="font-display font-semibold text-base mb-2">Welcome to Lifestyle Creep</h2>
          ...
          <section id="eligibility">
            <h2 className="font-display font-semibold text-base mb-2">Eligibility</h2>
            <p className="text-muted-foreground">
          ...
          <section id="account">
            <h2 className="font-display font-semibold text-base mb-2">Your Account</h2>
            <p className="text-muted-foreground">
          ...
          <section id="acceptable-use">
            <h2 className="font-display font-semibold text-base mb-2">Acceptable Use</h2>
          ...
          <section id="user-content">
            <h2 className="font-display font-semibold text-base mb-2">User Content</h2>
            <p className="text-muted-foreground">
          ...
          <section id="pricing">
            <h2 className="font-display font-semibold text-base mb-2">Pricing</h2>
            <p className="text-muted-foreground">
          ...
          <section id="disclaimers">
            <h2 className="font-display font-semibold text-base mb-2">Disclaimers</h2>
            <p className="text-muted-foreground">
          ...
          <section id="liability">
            <h2 className="font-display font-semibold text-base mb-2">Limitation of Liability</h2>
            <p className="text-muted-foreground">
          ...
          <section id="termination">
            <h2 className="font-display font-semibold text-base mb-2">Termination</h2>
            <p className="text-muted-foreground">
          ...
          <section id="changes">
            <h2 className="font-display font-semibold text-base mb-2">Changes to These Terms</h2>
            <p className="text-muted-foreground">
          ...
          <section id="governing-law">
            <h2 className="font-display font-semibold text-base mb-2">Governing Law</h2>
            <p className="text-muted-foreground">
